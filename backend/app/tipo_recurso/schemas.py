...
class TipoRecursoBase(BaseModel):
    ...
    nombre_tipo_recurso: str = Field(..., max_length=100, description="Nombre del tipo de recurso")
    descripcion_tipo_recurso: str = Field(..., max_length=255, description="Descripción del tipo de recurso")
...
class TipoRecursoUpdate(BaseModel):
    ...
    nombre_tipo_recurso: Optional[str] = Field(..., max_length=100, description="Nombre del tipo de recurso")
    descripcion_tipo_recurso: Optional[str] = Field(..., max_length=255, description="Descripción del tipo de recurso")
